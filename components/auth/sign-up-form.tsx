  ...
  return (
    <Card className="w-full max-w-md">
      <CardHeader className="text-center">
        <CardTitle className="text-2xl font-heading font-black text-primary">Join MANUS</CardTitle>
        <CardDescription>Create your account to start managing your wardrobe</CardDescription>
      </CardHeader>
      ...
      <CardContent>
        <form action={googleFormAction} className="mb-4">
          ...
          {googleState?.success && (
            <div className="bg-accent/10 border border-accent/50 text-accent px-4 py-3 rounded mb-4">
              {googleState.success}
            </div>
          )}
          <GoogleSignUpButton />
        ...
        <form action={formAction} className="space-y-4">
          ...
          {state?.success && (
            <div className="bg-accent/10 border border-accent/50 text-accent px-4 py-3 rounded">{state.success}</div>
          )}
